# Web Framework Integration | Deployment

Learn how Mastra can be deployed when integrated with a Web Framework

Source: https://mastra.ai/docs/deployment/web-framework
...
astro.config.mjs 
```
import { defineConfig } from "astro/config";import netlify from "@astrojs/netlify";export default defineConfig({  // ...  adapter: netlify(),  output: "server",});
```